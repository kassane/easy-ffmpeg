...
_easy_ffmpeg() {
  ...
  local cmds="convert compress trim resize audio-extract probe concat gif thumbnail speed rotate watermark subtitle metadata normalize replace-audio"
  ...
  case "$subcmd" in
    convert)
      ...
      ;;
    compress)
      COMPREPLY=($(compgen -W "--web --mobile --streaming --compress --crf --preset --codec --audio-codec --video-bitrate --bitrate --dry-run --help -h" -- "$cur"))
      ;;
    trim)
    ...
    gif)
      ...
      ;;
    thumbnail)
      COMPREPLY=($(compgen -W "--time --every --dry-run --help -h" -- "$cur"))
      ;;
    speed)
